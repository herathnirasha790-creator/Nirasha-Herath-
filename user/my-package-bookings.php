...
// ✅ Fetch ONLY Package Bookings (booking_type = 'package') with payment_status
$stmt = $conn->prepare("
    ...
    WHERE eb.user_id = ? AND eb.booking_type = 'package'
...
<head>
    <meta charset="UTF-8">
    <title>My Package Bookings | Royal Estate</title>
    ...
    <div class="main-content">
        <div class="top-bar">
            <div class="top-bar-left">
                ...
                <h2><i class="fas fa-gift"></i> My Package Bookings</h2>
            </div>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <a href="../packages.php" class="btn-book-new"><i class="fas fa-plus-circle"></i> Browse Packages</a>
            </div>
                ...
                <table id="bookingsTable">
                    ...
                    <tbody id="bookingsTableBody">
                        <?php if (empty($bookings)): ?>
                            <tr><td colspan="7" class="no-results">No package bookings found.</td></tr>
                        <?php else: ?>
                            ...
                            <tr data-hall-id="<?php echo $b['hall_id']; ?>" data-package-id="<?php echo $b['package_id']; ?>" data-event-date="<?php echo $b['event_date']; ?>">
                                ...
                                <td data-label="Status">
                                    <?php 
                                    // ✅ Always show "Paid" for package bookings
    ...
    function applyFilters() {
        ...
        if (visibleCount === 0) {
            if (!noResultRow) {
                ...
                tr.innerHTML = `<td colspan="7" class="no-results"><i class="fas fa-search" style="font-size:1.5rem;color:#c5a263;display:block;margin-bottom:0.5rem;"></i>No package bookings match your filters.</td>`;
