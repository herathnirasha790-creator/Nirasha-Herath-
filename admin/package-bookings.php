...
// ✅ Fetch Package Bookings (only booking_type = 'package')
$bookings = $conn->query("
    ...
    $where AND eb.booking_type = 'package'
...
<head>
    <meta charset="UTF-8">
    <title>Package Bookings | Royal Estate Admin</title>
...
<div class="admin-container">
    ...
    <div class="main-content">
        <div class="top-bar">
            <h2><i class="fas fa-gift"></i> Package Bookings</h2>
        ...
        <div class="card">
            <div class="card-header">
                <h3><i class="fas fa-list"></i> All Package Bookings <span class="badge-count"><?php echo $total_count; ?></span></h3>
            </div>
            ...
            <div class="filter-bar">
                ...
                <a href="package-bookings.php" class="btn-clear"><i class="fas fa-times"></i> Clear</a>
            </div>
                ...
                <table>
                    ...
                    <tbody>
                        <?php if(empty($bookings)): ?>
                            <tr><td colspan="9" class="no-results">No package bookings found.</td></tr>
                        <?php else: ?>
