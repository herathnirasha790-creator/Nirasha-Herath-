...
if (!empty($from_date) && !empty($to_date)) {
    $where .= " AND DATE(eb.event_date) >= '$from_date' AND DATE(eb.event_date) <= '$to_date'";
}
if (!empty($filter_month)) {
    $where .= " AND DATE_FORMAT(eb.event_date, '%Y-%m') = '$filter_month'";
}

// ✅ Fetch Event Bookings (excluding package type)
$bookings = $conn->query("
    SELECT eb.id, u.name AS customer, u.email, h.name AS hall, 
           eb.event_date, p.name AS package, eb.guests, 
    ...
    $where AND eb.booking_type = 'event_hall'
...
<head>
    <meta charset="UTF-8">
    <title>Event Bookings | Royal Estate Admin</title>
...
<div class="admin-container">
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="sidebar-nav">
            ...
            <a href="event-bookings.php" class="active"><i class="fas fa-calendar-alt"></i> Event Bookings</a>
    ...
    <div class="main-content">
        <div class="top-bar">
            <h2><i class="fas fa-calendar-alt"></i> Event Bookings</h2>
        ...
        <div class="card">
            <div class="card-header">
                <h3><i class="fas fa-list"></i> All Event Bookings <span class="badge-count"><?php echo $total_count; ?></span></h3>
            </div>
            ...
            <div class="filter-bar">
                ...
                <a href="event-bookings.php" class="btn-clear"><i class="fas fa-times"></i> Clear</a>
            </div>
                ...
                <table>
                    ...
                    <tbody>
                        <?php if(empty($bookings)): ?>
                            <tr><td colspan="9" class="no-results">No event bookings found.</td></tr>
                        <?php else: ?>
