...
<head>
    ...
    <title>Contact Us | Royal Estate - Luxury Hotel & Events in Kurunegala</title>
    ...
    <style>
        /* ========== YOUR ORIGINAL CONTACT.PHP STYLES ========== */
        * {
            margin: 0;
            padding: 0;
        ...
        .page-header {
            height: 40vh;
            background: linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.7)), url('https://images.unsplash.com/photo-1423666639041-f56000c27a9a?w=1600');
...
<section class="contact-section">
    <div class="contact-container">
        ...
        <div class="contact-info">
            <h2>Get In Touch</h2>
            <p>We'd love to hear from you! Whether you have a question about our rooms, events, or need assistance with booking, our team is here to help.</p>
            ...
            <div class="info-cards">
                <div class="info-card">
                    ...
                    <div class="info-details">
                        <h4>Visit Us</h4>
                        <p>No. 123, Colombo Road,<br>Kurunegala, Sri Lanka</p>
                    </div>
                </div>
                ...
                <div class="info-card">
                    ...
                    <div class="info-details">
                        <h4>Call Us</h4>
                        <p><a href="tel:+94372221234">+94 37 222 1234</a><br>
                        <a href="tel:+94771234567">+94 77 123 4567</a> (Hotline)</p>
                    </div>
                </div>
                ...
                <div class="info-card">
                    ...
                    <div class="info-details">
                        <h4>Email Us</h4>
                        <p><a href="mailto:info@royalestate.lk">info@royalestate.lk</a><br>
                        <a href="mailto:reservations@royalestate.lk">reservations@royalestate.lk</a></p>
                    </div>
                </div>
                ...
                <div class="info-card">
                    ...
                    <div class="info-details">
                        ...
                        Office: 9:00 AM - 9:00 PM (Daily)</p>
                    </div>
                </div>
            </div>
            ...
            <div class="map-container">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d126387.56367705716!2d80.28319515!3d7.48621675!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae33bb6e8fa1a8b%3A0x6e2a3f8e4f2a5c7d!2sKurunegala!5e0!3m2!1sen!2slk!4v1700000000000!5m2!1sen!2slk" allowfullscreen="" loading="lazy"></iframe>
            </div>
        </div>
        ...
        <div class="contact-form">
            ...
            <div id="successMessage" class="success-message">
                <i class="fas fa-check-circle"></i> <span id="successText">Thank you! Your message has been sent successfully.</span>
            </div>
            ...
            <form id="contactForm" method="POST">
                <div class="form-row">
                    <div class="form-group">
                        <input type="text" id="name" name="name" placeholder="Your Full Name" value="<?php echo $is_logged_in ? htmlspecialchars($user_name) : ''; ?>" required>
                    </div>
                    <div class="form-group">
                        <input type="email" id="email" name="email" placeholder="Email Address" value="<?php echo $is_logged_in ? htmlspecialchars($user_email) : ''; ?>" required>
                    </div>
                </div>
                ...
                <?php if ($is_logged_in): ?>
                    <p style="text-align:center; font-size:0.75rem; color:#888; margin-top:0.5rem;">
                        <i class="fas fa-user-check" style="color:#28a745;"></i> You are logged in as <strong><?php echo htmlspecialchars($user_name); ?></strong>
                    </p>
                <?php endif; ?>
            </form>
        </div>
    ...
    <div class="faq-container">
        ...
        <div class="faq-grid">
            <div class="faq-item">
                ...
                <p>You can book a room directly through our website by visiting the Rooms page, or call our reservation hotline for assistance.</p>
            </div>
            <div class="faq-item">
                <div class="faq-question">
                    <i class="fas fa-question-circle"></i>
                ...
                <p>Yes, cancellations are allowed up to 48 hours before check-in for a full refund. Please check our cancellation policy for details.</p>
            </div>
            <div class="faq-item">
                <div class="faq-question">
                    <i class="fas fa-question-circle"></i>
                    <h4>Do you offer event packages?</h4>
                </div>
                <p>Yes, we offer various event packages for weddings, parties, and corporate events. Check our Packages page for details.</p>
            </div>
            <div class="faq-item">
                <div class="faq-question">
                    <i class="fas fa-question-circle"></i>
                ...
                <p>Yes, we have free parking facilities for all our guests and event attendees.</p>
            </div>
            <div class="faq-item">
                <div class="faq-question">
                    <i class="fas fa-question-circle"></i>
                ...
                <p>Yes, we offer vegetarian and vegan options for all our food packages. Please inform us in advance.</p>
            </div>
            <div class="faq-item">
                <div class="faq-question">
                    <i class="fas fa-question-circle"></i>
                ...
                <p>We accept cash, credit/debit cards (Visa, Mastercard), and bank transfers.</p>
            </div>
        </div>
    </div>
</section>
        ...
        contactForm.addEventListener('submit', async function(e) {
            ...
            try {
                ...
                if (data.success) {
                    ...
                    // If user is logged in, refill name and email fields
                    <?php if ($is_logged_in): ?>
                        document.getElementById('name').value = '<?php echo addslashes($user_name); ?>';
                        document.getElementById('email').value = '<?php echo addslashes($user_email); ?>';
                    <?php endif; ?>
